---
name: "source-command-backtest-regression"
description: "Run the backtest-regression harness — locks the S27/S32/S34/S35 claims against the current engine"
---

# source-command-backtest-regression

Use this skill when the user asks to run the migrated source command `backtest-regression`.
