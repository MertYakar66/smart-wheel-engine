# PROJECT_STATE.md §3 "Work in progress" — pre-restart narrative (2026-05-04 → 2026-07-08)

> **Archived 2026-09-17** (restart structure pass, Track F —
> `docs/RESTART_PLAN_2026-09-16.md` §7a "documentation mass"). This is the
> verbatim §3 of `PROJECT_STATE.md` as it stood after the summer break
> (`origin/main` @ `ec1c5c5`, 2026-07-28): a newest-first, dated narrative of
> the May–July 2026 campaigns. Preserved as history; not maintained; not
> current reference. The live state doc keeps only the items still open.
> File paths inside refer to the tree of that date (several were archived
> or removed since — `archive/README.md` and `CHANGELOG.md` say where).
