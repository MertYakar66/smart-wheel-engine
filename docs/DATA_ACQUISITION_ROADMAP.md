...
| VIX family (VIX, VVIX, SKEW, VXN, RVX, VXEEM, OVX, GVZ) | `… Index` `PX_LAST` (BQL §5) | `regime_detector`, `tail_risk`, `dealer_positioning` — SKEW tail regimes, VVIX vol-of-vol, sector/EM/oil/gold breadth. `sp500_vix_full.csv` holds 2015-01-02 → 2026-06-05 (17,274 rows) → optionally extend back to 2011. | P1-high | BDH | advisory-sizing |
