...
The desktop pulled all 17,188 home and checked them on 2026-09-23 (0 differences). The rest stays on the MacBook, which is outside the data estate (D33). **Since D34 (2026-09-26):** Drive's `SmartWheelData/data_processed/theta` (uploaded 2026-07-12/13) held 132,862 Theta files (11,633,788,580 B) at card 1's census. The desktop's 17,188 are among them byte for byte, and the other 115,293 come home in card 2, into `data_archive/drive-legacy/`, beside the live tree. Theta is kept like Bloomberg: nothing that holds it is deleted until the desktop copy and the Drive copy are both proven._
