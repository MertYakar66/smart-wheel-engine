...
>
> _Currency note (2026-07-02): counts in this snapshot predate `corporate_actions` joining `_FILES` — the connector now reads **10** monolith files (plus two `broad_pull/` panels, fingerprint-pinned since #465); the producer census (3 refreshable) is unchanged. Current counts: `docs/DATA_POLICY.md` §5._
