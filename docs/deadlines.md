...
| --- | ---- | ----- | ------ | ------ |
| Undated | ThetaData subscription: when does it renew or lapse? The laptop's Theta corpus and every Theta pull depend on it. | Operator: supply the date | **OPEN**: no date recorded anywhere in the repository | `docs/LAPTOP_SETUP.md` §3 (the tier record) |
...
| Theta corpus (~132,862 files) | unknown until the laptop transfer lands | the data laptop; Drive holds 17,188 files | `docs/DATA_INVENTORY.md` §A row 2b |
