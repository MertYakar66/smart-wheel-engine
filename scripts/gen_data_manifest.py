...
SERVED = {
    "sp500_ohlcv.csv": "ohlcv", "sp500_vol_iv_full.csv": "vol_iv",
    "sp500_dividends.csv": "dividends", "sp500_earnings.csv": "earnings",
    "treasury_yields.csv": "treasury", "vix_term_structure.csv": "vix",
    "sp500_fundamentals.csv": "fundamentals", "sp500_credit_risk.csv": "credit_risk",
    "sp500_liquidity.csv": "liquidity", "sp500_corporate_actions.csv": "corporate_actions",
}
# in-repo producer (edit end_date / SWE_PULL_END), where one exists
PRODUCER = {
    "sp500_ohlcv.csv": "scripts/pull_ohlcv.py", "sp500_vol_iv_full.csv": "scripts/pull_vol_iv.py",
    "sp500_liquidity.csv": "scripts/pull_liquidity.py", "treasury_yields.csv": "scripts/pull_treasury_yields.py",
    "vix_term_structure.csv": "scripts/pull_vix_term_structure.py", "sp500_dividends.csv": "scripts/pull_dividends.py",
    "sp500_corporate_actions.csv": "scripts/pull_corporate_actions.py", "sp500_fundamentals.csv": "scripts/pull_snapshots.py",
    "sp500_credit_risk.csv": "scripts/pull_snapshots.py", "sp500_snapshot_bdp.csv": "scripts/pull_snapshot_bdp.py",
    "sp500_dividend_yield_pit.csv": "scripts/pull_dividend_yield_pit.py", "sp500_short_interest.csv": "scripts/pull_short_interest.py",
    "sp500_historical_fundamentals.csv": "scripts/pull_historical_fundamentals.py", "sp500_index_membership.csv": "scripts/pull_index_membership.py",
    "sp500_sector_etfs.csv": "scripts/pull_sector_etfs.py", "sp500_macro.csv": "scripts/pull_macro.py",
    "sp500_vix_full.csv": "scripts/pull_vix_full.py",
}
# deep-archive slices (gitignored, Drive-only) — title -> size (from Drive)
DEEP = {
    "sp500_ohlcv__1994_2018.csv.gz": 31705057, "sp500_ohlcv__delisted.csv.gz": 34075979,
    "sp500_vol_iv_full__1994_2012.csv.gz": 28297508, "sp500_vol_iv_full__2012_2018.csv.gz": 10596777,
    "sp500_vol_iv__delisted.csv.gz": 40025527, "sp500_liquidity__1994_2015.csv.gz": 20919884,
    "sp500_liquidity__delisted.csv.gz": 24169257, "sp500_iv_surface__2005_2011.csv.gz": 51586372,
    "sp500_iv_surface__2012_2018.csv.gz": 59392342, "sp500_iv_surface__2019_2026.csv.gz": 72500413,
    "delisted_status.csv": 71569, "ohlcv_dropped_ticks.csv": 8962,
...
for title, size in DEEP.items():
    files.append({
        "path": f"{BBG}/deep/{title}", "basename": title, "size": size, "sha256": None,
        "drive_folder": FOLDERS["data/bloomberg/deep"], "served": False, "engine_key": None,
        "producer": None, "tier": "deep-archive (opt-in, gitignored)",
    })
...
manifest = {
    ...
    "counts": {"git_tracked": sum(1 for f in files if f["tier"] == "git-tracked"),
...
print(f"wrote data/data_manifest.json: {len(files)} files "
