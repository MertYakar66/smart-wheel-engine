...
class TestZeroDTE:
    ...
    def test_zero_dte_otm_put(self):
        ...
        price = estimate_option_price_from_iv(
            underlying_price=110, strike=100, dte=0, iv=0.25, risk_free_rate=0.05, option_type="put"
        )
        assert price == 0
    ...
    def test_zero_dte_itm_put(self):
        ...
        price = estimate_option_price_from_iv(
            underlying_price=90, strike=100, dte=0, iv=0.25, risk_free_rate=0.05, option_type="put"
        )
        assert price == 10
    ...
    def test_zero_dte_otm_call(self):
        ...
        price = estimate_option_price_from_iv(
            underlying_price=90, strike=100, dte=0, iv=0.25, risk_free_rate=0.05, option_type="call"
        )
        assert price == 0
...
class TestMarginCalculation:
    ...
    def test_atm_margin(self):
        ...
        margin = calculate_reg_t_margin_short_put(strike=100, underlying_price=100, premium=3.00)
    ...
    def test_otm_margin(self):
        ...
        otm_margin = calculate_reg_t_margin_short_put(strike=90, underlying_price=100, premium=1.50)
        atm_margin = calculate_reg_t_margin_short_put(
            strike=100, underlying_price=100, premium=3.00
        )
...
class TestSlippageEdgeCases:
    ...
    def test_zero_spread_slippage(self):
        ...
        slippage = calculate_slippage(mid_price=2.50, bid_ask_spread=0.0, trade_direction="sell")
        assert slippage == 0
    ...
    def test_very_illiquid_option(self):
        ...
        liquid_slippage = calculate_slippage(
            mid_price=2.50, bid_ask_spread=0.10, trade_direction="sell", open_interest=1000
        )
        illiquid_slippage = calculate_slippage(
            mid_price=2.50, bid_ask_spread=0.10, trade_direction="sell", open_interest=10
        )
